%% includeRnw v0.0.1b1 - 2018/04/20
%% The LaTeX package includeRnw - version v0.0.1 (2018/04/20) build 1
...
\title{{includeRnw - manual\\ v0.0.1{\\[-0.5em]\footnotesize(build 1)}}}
...
Compiles .Rnw-files using R. Assumes that \dac{texttt}\{R\} can be called
